      ...
      <div className="flex items-center gap-1">
        ...
        {hasHalfStar && (
          <svg key="half" className="w-5 h-5 text-yellow-400" viewBox="0 0 20 20">
            ...
            <path fill={`url(#half-${provider.id})`} d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
          </svg>
        )}
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition-shadow duration-200">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-indigo-600">${provider.price}</div>
